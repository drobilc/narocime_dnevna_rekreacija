...
# Inicializiramo storitev za posliljanje obvestil na telefon 
pushbulletKlient = Pushbullet("api_kljuc")
...
if len(fitnesDogodki) > 0:
	...
	# Posljemo obvestilo na pushbullet
	pushbulletKlient.push_note("Prijava na vadbo", "Prijavljanje na vadbo z naslovom '{}', ki traja od {} do {}.".format(dogodek.title, dogodek.start, dogodek.end))
